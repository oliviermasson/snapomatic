...
class startOracleRAC:
    ...
    def go(self,**kwargs):
        ...
        out=doProcess.doProcess(self.home + '/bin/srvctl start database -db ' + self.sid \
        ...
        if out.result > 0:
            ...
            for line in out.stdout:
                if 'PRCR-1004' in line:
                    self.reason="Database is already running"
                    break
